const translations = {
  ...
  uz: {
    ...
    features: {
      badge:    'NEUROXISE Afzalliklari',
      title1:   'Dalillarga asoslangan tibbiyot',
      title2:   'va ilg\'or reabilitatsiya algoritmlari',
      subtitle: 'Platforma neyroplastiklik tamoyillari hamda nutq, harakat va kognitiv funksiyalarni tiklashning dalillarga asoslangan usullariga tayanib, reabilitatsiya jarayonini uzluksiz va boshqariladigan qiladi.',
      items: [
        {
          title: 'Moslashuvchan protokollar',
          desc:  'Tizim vazifalarni bajarish dinamikasini tahlil qiladi va qiyinchilikni bemorning joriy holatiga qarab avtomatik tarzda moslashtiradi, optimal va xavfsiz terapevtik yuklamani ta\'minlaydi.',
        },
        {
          title: 'Obyektiv nazorat',
          desc:  'Harakat va nutq reaksiyalarini aniq qayd etish. Platforma bemor va uning davolovchi shifokori uchun tiklanish dinamikasi haqida batafsil, tuzilgan hisobotlarni shakllantiradi.',
        },
        {
          title: 'Terapevtik sinergiya',
          desc:  'Interaktiv ixtisoslashtirilgan mexanikalar bemorni davolanish jarayoniga jalb qiladi, harakat po\'stlog\'ini rag\'batlantiradi va kundalik mashg\'ulotlar muntazamligini qo\'llab-quvvatlaydi.',
        },
        {
          title: 'Lokalizatsiya va ochiqlik',
          desc:  'Interfeys va maxsus nutq mashqlari o\'zbek, rus va ingliz tillariga to\'liq moslashtirilgan, bu esa nutqni to\'g\'ri tiklash uchun juda muhimdir.',
        },
        {
          title: 'Muxtoriyat va xavfsizlik',
          desc:  'Asosiy tiklanish modullari internetga ulanmasdan to\'liq avtonom ishlaydi. Bemor ma\'lumotlari qat\'iy sir saqlanadi va qurilmada lokal saqlanishi mumkin.',
        },
        {
    ...
    howItWorks: {
      ...
      title:    'Tiklanishning bosqichma-bosqich jarayoni',
      subtitle: 'Mashg\'ulotlarga tizimli yondashuv asab tizimidagi tiklanish jarayonlarini boshlash va klinik dinamikani kuzatish imkonini beradi.',
      cta:      'Tiklanish dasturini boshlash →',
      steps: [
        {
          title: 'Defitsitni dastlabki baholash',
          desc:  'Bemor insult yoki jarohatdan keyingi buzilishlarning xususiyati va darajasini aniqlash uchun nutq, harakat va kognitiv funksiyalarining boshlang\'ich sinovidan o\'tadi.',
        },
        {
          title: 'Muntazam yo\'naltirilgan sessiyalar',
          desc:  'Yo\'qotilgan funksiyalarni tiklash uchun javobgar bo\'lgan miya hududlarini faollashtirish maqsadida maxsus modullar bo\'yicha kunlik maqsadli mashg\'ulotlarni bajarish.',
        },
        {
    ...
    exercises: {
      ...
      title1:   'Harakat va nutqni tiklashning',
      title2:   'kompleks dasturi',
      subtitle: 'Bemorning mustaqil shug\'ullanishi uchun maxsus modullar va yonidagi insonlar uchun video qo\'llanmalar.',
      tryBtn:   'Sinab ko\'rish',
      focusTitle: 'Modulning terapevtik fokusi',
      ...
      categories: [
        {
          ...
          color: '#3D52F5',
          bg:   '#EEF0FF',
          desc: 'Harakatlarni muvofiqlashtirish, barmoqlar va qo\'l panjalarini rivojlantirish hamda nevrologik buzilishlardan so\'ng harakat sinergiyasini tiklashga qaratilgan interaktiv raqamli mashqlar.',
          btnText: 'Mashqlarni ochish',
          focusPoints: [
            'Qo\'l bo\'g\'imlarining harakatchanligi va egiluvchanligini rivojlantirish',
            'Harakatlar muvofiqligini va ushlash aniqligini tiklash',
            'Barmoqlarni alohida boshqarishni mashq qilish',
            'Sensor reaksiya orqali bosh miya harakat po\'stlog\'ini rag\'batlantirish',
          ],
          exercises: []
        },
        {
          ...
          color: '#3D52F5',
          bg:   '#EEF0FF',
          desc: 'Qarindoshlar va yaqinlar uchun bosqichma-bosqich video darslar va amaliy qo\'llanmalar. Bemorni ko\'chirish, joylashtirish va asosiy gimnastikani bajarishda to\'g\'ri yordam ko\'rsatish texnikasini o\'rgatamiz.',
          btnText: 'Video darslarni ko\'rish',
          focusPoints: [
            'Bemorni xavfsiz ko\'chirish va joyini o\'zgartirish texnikasiga o\'rgatish',
            'Asoratlarning oldini olish uchun yotoqda to\'g\'ri joylashtirish',
            'Bo\'g\'imlar harakatchanligini saqlash uchun passiv gimnastika komplekslari',
            'Yirik mushak guruhlarini ehtiyotkorlik bilan faollashtirish usullari',
          ],
          exercises: []
        },
        {
          ...
          color: '#3D52F5',
          bg:   '#EEF0FF',
          desc: 'Afaziya bilan og\'rigan bemorlar uchun maxsus mashqlar. Ular nutqni tushunishdagi to\'siqlarni yengishga yordam beradi hamda tovushlar va so\'zlarni mustaqil talaffuz qilish jarayonini rag\'batlantiradi.',
          btnText: 'Nutq terapiyasini boshlash',
          focusPoints: [
            'Nominativ nutqni tushunishni tiklash (narsalarni tanish)',
            'Mustaqil talaffuzni rag\'batlantirish va nutq to\'siqlarini yengish',
            'Artikulyatsion harakatlarni avtomatlashtirish va tovushlarni qaytarish',
            'Frazali nutq va muloqot ko\'nikmalarini bosqichma-bosqich tiklash',
          ],
          exercises: []
        },
        {
          ...
          color: '#3D52F5',
          bg:   '#EEF0FF',
          desc: 'Miya zararlanganda eng zaif bo\'lgan oliy ruhiy funksiyalarni mashq qilish. Diqqatni jamlash, operativ xotira va rejalashtirish qobiliyatini tiklash.',
          btnText: 'Modulga o\'tish',
          focusPoints: [
            'Fiksatsion amneziyani yengish va qisqa muddatli xotirani rivojlantirish',
            'Diqqat barqarorligini, jamlanishini va o\'zgaruvchanligini mashq qilish',
            'Ko\'ruv-fazoviy mo\'ljalni tiklash',
      ...
      plans: [
        {
          ...
          price: '$15',
          per:   'abadiy',
          desc:  'Mustaqil uy sharoitida tiklanish uchun bazaviy mashqlar kursi.',
          cta:   '14 kunlik sinov davri',
          ctaStyle: 'outline',
          features: [
            'Kichik motorika va nutq (Afaziya) bazaviy modullariga kirish',
            'Harakat va nutq funksiyalarini dastlabki baholash',
            'Mashg\'ulot natijalarini qurilmada lokal saqlash',
            'Mashg\'ulotlar muntazamligini kunlik nazorat qilish',
            'Afaziya turi va defitsitlarni aniqlash uchun boshlang\'ich skrining',
          ],
        },
        {
          name:  'Premium',
          ...
          popular: true,
          features: [
            'Platformaning barcha 4 moduliga to\'liq kirish (kognitiv modulni ham o\'z ichiga oladi)',
            'Yaqinlar uchun yirik motorika bo\'yicha video darslar kutubxonasiga kirish',
            'Nutq va harakat defitsitlarining kengaytirilgan avtomatik diagnostikasi',
            'Vazifalar qiyinchiligini bemor holatiga mos ravishda dinamik moslashtirish',
            'Davolovchi shifokorga ko\'rsatish uchun tuzilgan hisobotlarni eksport qilish',
            'Ustuvor texnik yordam',
            'Afaziya shaklini aniqlagan holda nutq buzilishlarining kengaytirilgan ekspert diagnostikasi',
          ],
        },
        {
          name:  'ENTERPRISE',
          ...
          per:   '',
          desc:  'Platformani tibbiyot markazlari va soha mutaxassislari amaliyotiga integratsiya qilish.',
          cta:   'Savdo bo\'limi bilan bog\'lanish',
          ctaStyle: 'outline',
          features: [
            'Premium tarifining barcha imkoniyatlari',
            'Ko\'plab bemorlarni bir vaqtda olib borish va kuzatish uchun shifokor paneli',
            'Reabilitolog tomonidan mashg\'ulot protokollarini qo\'lda to\'g\'rilash imkoniyati',
