  ...
  return (
    <section id="download" style={{ padding: '96px 0', background: '#fff' }}>
        ...
        <div className="download-card">
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div className="store-btns">
              <button type="button" className="store-btn store-btn-soon" disabled aria-label={`${d.appStore}: ${d.comingSoon}`}>
              ...
              <button type="button" className="store-btn store-btn-soon" disabled aria-label={`${d.playStore}: ${d.comingSoon}`}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      ...
      <style>{`
        ...
        .store-btn:hover:not(:disabled) { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,0,0,0.22); }
        .store-btn-soon:disabled {
          opacity: 0.72;
          cursor: not-allowed;
        }
